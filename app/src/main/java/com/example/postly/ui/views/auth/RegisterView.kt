...
@Composable
fun RegisterView(onSwitchToLogin: () -> Unit, onRegister: suspend (String, String, String) -> String?, isLoading: Boolean, modifier: Modifier = Modifier) {
    ...
    Column(modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(20.dp)) {
        ...
        Button(
            onClick = {
                ...
                if (errorMessage == null) scope.launch { errorMessage = onRegister(name.trim(), email.trim(), password) }
            },
            ...
            if (isLoading) CircularProgressIndicator(color = androidx.compose.ui.graphics.Color.White, modifier = Modifier.size(22.dp), strokeWidth = 2.dp) else Text("Register", fontSize = 17.sp)
        }
